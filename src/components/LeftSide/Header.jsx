...
import { changeInfo } from '../../covidSlice'
...
export default function Header() {
    ...
    const changeOption = (e) => {
        ...
        setCountryName((allCountryInfos.find(info => e.target.value === info.countryInfo.iso3)));
            ...
            <FormControl >
                <Select value={countryISO} onChange={changeOption}>
                    ...
                    {allCountryInfos.map((country, index) =>
                        <MenuItem key={index} value={country.countryInfo.iso3} >{country.countryName}</MenuItem>
                    )}
                </Select>
            </FormControl>
